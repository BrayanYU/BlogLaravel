            ...
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <form action="{{ route('posts.update', $post) }}" method="post" enctype="multipart/form-data">
                    ...
                    <x-label for="title" value="Post title" class="mb-2" style="
                        font-size: 16px;
                    "/>
                    <x-input id="title" name="title" class="mb-4" value="{{ $post->title }}" style="
                        width: 40%;
                        height: 40px;
                        padding: 4px;
                    ...
                    <x-button style="display: block !important" class="mt-5">Edit a post</x-button>
                </form>
            </div>
        </body>
    </html>
